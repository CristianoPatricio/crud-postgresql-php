...
if (!isset($_SESSION['loggedinUser-CRU'])) {
...
<body class="loggedin">
	...
	<div class="content">
		...
		<div>
				...
				<div class="form-row">
					...
					<script>
						function getItemValue() {
							...
							window.location.href = "sinistros-cru.php?item=" + itemSelect;
						}
					</script>
					<div class="form-group col-md-4">
			...
			<form action="sinistros-cru.php" method="get" style="background-color: #e3e8e5; padding: 10px; border-radius: 5px;">
				<div class="form-row">
					<div class='form-group col-md-2'>
					...
					<?php if (!empty($dados)) : ?>
						...
						<div class='box-paginacao'>
							<?php if ((!(isset($_GET['dataInicio'])) || !(isset($_GET['dataFim']))) || $_GET['dataInicio'] == null || $_GET['dataFim'] == null) : ?>
								<a class='btn btn-info box-navegacao <?= $exibir_botao_inicio ?>' href="sinistros-cru.php?page=<?= $primeira_pagina ?>" title="Primeira Página">
									<<</a> <a class='btn btn-info box-navegacao <?= $exibir_botao_inicio ?>' href="sinistros-cru.php?page=<?= $pagina_anterior ?>" title="Página Anterior">
										<</a> <?php
														/* Loop para montar a páginação central com os números */
														for ($i = $range_inicial; $i <= $range_final; $i++) :
															$destaque = ($i == $pagina_atual) ? 'destaque' : '';
															?> <a class='box-numero <?= $destaque ?>' href="sinistros-cru.php?page=<?= $i ?>"><?= $i ?>
								</a>
							<?php endfor; ?>
							<a class='btn btn-info box-navegacao <?= $exibir_botao_final ?>' href="sinistros-cru.php?page=<?= $proxima_pagina ?>" title="Próxima Página">></a>
							<a class='btn btn-info box-navegacao <?= $exibir_botao_final ?>' href="sinistros-cru.php?page=<?= $ultima_pagina ?>" title="Última Página">>></a>
						<?php else : ?>
							<a class='btn btn-info box-navegacao <?= $exibir_botao_inicio ?>' href="sinistros-cru.php?page=<?= $primeira_pagina ?>&dataInicio=<?php echo $_GET['dataInicio']; ?>&dataFim=<?php echo $_GET['dataFim']; ?>" title="Primeira Página">
								<<</a> <a class='btn btn-info box-navegacao <?= $exibir_botao_inicio ?>' href="sinistros-cru.php?page=<?= $pagina_anterior ?>&dataInicio=<?php echo $_GET['dataInicio']; ?>&dataFim=<?php echo $_GET['dataFim']; ?>" title="Página Anterior">
									<</a> <?php
													/* Loop para montar a páginação central com os números */
													for ($i = $range_inicial; $i <= $range_final; $i++) :
														$destaque = ($i == $pagina_atual) ? 'destaque' : '';
														?> <a class='box-numero <?= $destaque ?>' href="sinistros-cru.php?page=<?= $i ?>&dataInicio=<?php echo $_GET['dataInicio']; ?>&dataFim=<?php echo $_GET['dataFim']; ?>"><?= $i ?>
							</a>
						<?php endfor; ?>
						<a class='btn btn-info box-navegacao <?= $exibir_botao_final ?>' href="sinistros-cru.php?page=<?= $proxima_pagina ?>&dataInicio=<?php echo $_GET['dataInicio']; ?>&dataFim=<?php echo $_GET['dataFim']; ?>" title="Próxima Página">></a>
						<a class='btn btn-info box-navegacao <?= $exibir_botao_final ?>' href="sinistros-cru.php?page=<?= $ultima_pagina ?>&dataInicio=<?php echo $_GET['dataInicio']; ?>&dataFim=<?php echo $_GET['dataFim']; ?>" title="Última Página">>></a>
					<?php endif; ?>
						</div>
					<?php else : ?>
